...
const FeatureList: FeatureItem[] = [
  {
    ...
    image: 'https://pensplace.github.io/icon-menu-builder-docs/img/home-screen.png',
    description: (
      <>
  ...
  },
  {
    ...
    image: 'https://pensplace.github.io/icon-menu-builder-docs/img/myfavs.png',
    description: (
      <>
  ...
  },
  {
    ...
    image: 'https://pensplace.github.io/icon-menu-builder-docs/img/mymenus.png',
    description: (
      <>
